...
Firing with less than all gunners ready is non-optimum (this is not fire at will, this is fire by the captain's orders or walk the plank, dirty 
sea-dog!)
...
const cannonsReady = (gunners) => {
  return Object.values(gunners).indexOf("nay") === -1
    ? "Fire!"
    : "Shiver me timbers!";
};
