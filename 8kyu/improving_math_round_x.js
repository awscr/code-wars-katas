...
But that is sometimes not enough! What if we wanted to round 3.1415926535 to two decimal places? While some languages (such as PHP) has a round() 
function that supports rounding to a specified number of decimal places (e.g. <?php round(3.1415926535, 4); 3.1416 (rounded to 4 d.p. as specified)  
?>), Javascript does not!
Task
...
// Trials
console.log(Math.roundTo(1784.76234, 2)); //1784.76
console.log(Math.roundTo(3.14566, 3)); //3.146
console.log(Math.roundTo(857, 1)); //857
