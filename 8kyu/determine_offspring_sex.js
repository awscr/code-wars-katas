...
If the sperm contains the X chromosome, return "Congratulations! You're going to have a daughter."; If the sperm contains the Y chromosome, return 
...
console.log(chromosomeCheck("YX")); //"Congratulations! You're going to have a son."
